...
const Payment = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:8000/api/v1/order/payment/process', paymentData, {
            ...
            if (result.error) {
                ...
                if (result.paymentIntent.status === "succeeded") {
                    ...
                    try {
                    const orderRes = await axios.post('http://localhost:8000/api/v1/order/new', order, {
                            headers: { "Content-Type": "application/json" },
                            withCredentials: true
                        })
